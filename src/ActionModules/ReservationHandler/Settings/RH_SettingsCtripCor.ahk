RH_SettingsCtripCor(App) {
    ...
    return (
        ...
        ; profile name
        App.AddText("xs10 yp+25 w65 h25 0x200", "商旅现付"),
        App.AddEdit("x+10 h25 w230", ""),
        App.AddText("xs10 y+10 w65 h25 0x200", "商旅预付"),
        App.AddEdit("x+10 h25 w230", ""),
        ; profile type
        App.AddText("xs10 y+10 w65 h25 0x200", "Profile 类型"),
        App.AddRadio("x+20 h25", "Travel Agent"),
        App.AddRadio("x+10 h25 Checked", "Company"),
