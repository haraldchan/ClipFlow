RHS_SettingsCtrip(App, params) {
    ...
    comp.render := this => this.Add(
        ; profile
        App.ARGroupBox("Section x25 y100 w330 r4.5", "基本信息").SetFont("bold"),
        ; profile name
        ...
        ; related fields
        App.ARGroupBox("Section x25 y+30 w330 r5", "预订填入内容").SetFont("bold"),
        ; rate code
        ...
        ; save
        App.ARButton("v" . agent . "-save" . " x280 y+30 h30 w80", "保 存").OnEvent("Click", saveParams)
    )
